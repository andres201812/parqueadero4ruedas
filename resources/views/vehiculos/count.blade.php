							...
							<table id="example1" class="table table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td><input type="text" value="{{ $cantidad->marca }}" /></td>
										<td>{{ $cantidad->cantidad }}</td>
										<td>
											<a href="{{ route('vehiculos.edit',$cantidad->id) }}" class="btn btn-info btn-sm" title="Editar" id="enviar"><i class="fas fa-pencil-alt"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
